...
class GaussianDiffusion:
    ...
    def p_sample(
        ...
        if 'add_noise_to_exemplar' in new_model_kwargs.keys():
            if new_model_kwargs['add_noise_to_exemplar']:
                noise = th.randn_like(new_model_kwargs['exemplar_latent_ori'])
                exemplar_latent_t = self.q_sample(new_model_kwargs['exemplar_latent_ori'], t, noise=noise)
                map_tensor = th.tensor(self.timestep_map, device=t.device, dtype=t.dtype)
                new_ts = map_tensor[t]
                new_model_kwargs['exemplar_latent'] = exemplar_latent_t
                new_model_kwargs['exemplar_timestep'] = new_ts
                del new_model_kwargs['add_noise_to_exemplar']
                del new_model_kwargs['exemplar_latent_ori']
